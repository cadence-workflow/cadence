...
type EphemeralShardLimitExceededError struct {
	Namespace            string   `protobuf:"bytes,1,opt,name=namespace,proto3" json:"namespace,omitempty"`
	MaxLimit             int64    `protobuf:"varint,2,opt,name=max_limit,json=maxLimit,proto3" json:"max_limit,omitempty"`
...
func (m *EphemeralShardLimitExceededError) Reset()         { *m = EphemeralShardLimitExceededError{} }
func (m *EphemeralShardLimitExceededError) String() string { return proto.CompactTextString(m) }
func (*EphemeralShardLimitExceededError) ProtoMessage()    {}
func (*EphemeralShardLimitExceededError) Descriptor() ([]byte, []int) {
	return fileDescriptor_0055bfd59dff1f95, []int{4}
}
func (m *EphemeralShardLimitExceededError) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EphemeralShardLimitExceededError) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EphemeralShardLimitExceededError.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EphemeralShardLimitExceededError) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EphemeralShardLimitExceededError.Merge(m, src)
}
func (m *EphemeralShardLimitExceededError) XXX_Size() int {
	return m.Size()
}
func (m *EphemeralShardLimitExceededError) XXX_DiscardUnknown() {
	xxx_messageInfo_EphemeralShardLimitExceededError.DiscardUnknown(m)
}

var xxx_messageInfo_EphemeralShardLimitExceededError proto.InternalMessageInfo

func (m *EphemeralShardLimitExceededError) GetNamespace() string {
	if m != nil {
		return m.Namespace
	}
	return ""
...
func (m *EphemeralShardLimitExceededError) GetMaxLimit() int64 {
	if m != nil {
		return m.MaxLimit
	}
	return 0
...
func (m *EphemeralShardLimitExceededError) GetCurrentValue() int64 {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*EphemeralShardLimitExceededError)(nil), "uber.cadence.sharddistributor.v1.EphemeralShardLimitExceededError")
...
var fileDescriptor_0055bfd59dff1f95 = []byte{
	...
	,
}
...
func (m *EphemeralShardLimitExceededError) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EphemeralShardLimitExceededError) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EphemeralShardLimitExceededError) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.CurrentValue != 0 {
		i = encodeVarintService(dAtA, i, uint64(m.CurrentValue))
		i--
		dAtA[i] = 0x18
	}
	if m.MaxLimit != 0 {
		i = encodeVarintService(dAtA, i, uint64(m.MaxLimit))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Namespace) > 0 {
...
func (m *EphemeralShardLimitExceededError) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.MaxLimit != 0 {
		n += 1 + sovService(uint64(m.MaxLimit))
	}
	if m.CurrentValue != 0 {
		n += 1 + sovService(uint64(m.CurrentValue))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *EphemeralShardLimitExceededError) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EphemeralShardLimitExceededError: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EphemeralShardLimitExceededError: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
