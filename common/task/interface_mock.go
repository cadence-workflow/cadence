...
// Source: common/task/interface.go
//
// Generated by this command:
//
//	mockgen -package task -source common/task/interface.go -destination common/task/interface_mock.go -self_package github.com/uber/cadence/common/task
//
...
// MockTaskPool is a mock of TaskPool interface.
type MockTaskPool struct {
	ctrl     *gomock.Controller
	recorder *MockTaskPoolMockRecorder
	isgomock struct{}
}

// MockTaskPoolMockRecorder is the mock recorder for MockTaskPool.
type MockTaskPoolMockRecorder struct {
	mock *MockTaskPool
}

// NewMockTaskPool creates a new mock instance.
func NewMockTaskPool(ctrl *gomock.Controller) *MockTaskPool {
	mock := &MockTaskPool{ctrl: ctrl}
	mock.recorder = &MockTaskPoolMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockTaskPool) EXPECT() *MockTaskPoolMockRecorder {
	return m.recorder
}

// GetNextTask mocks base method.
func (m *MockTaskPool) GetNextTask() (PriorityTask, bool) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNextTask")
	ret0, _ := ret[0].(PriorityTask)
	ret1, _ := ret[1].(bool)
	return ret0, ret1
}

// GetNextTask indicates an expected call of GetNextTask.
func (mr *MockTaskPoolMockRecorder) GetNextTask() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNextTask", reflect.TypeOf((*MockTaskPool)(nil).GetNextTask))
}

// Len mocks base method.
func (m *MockTaskPool) Len() int {
	m.ctrl.T.Helper()
...
func (mr *MockTaskPoolMockRecorder) Len() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Len", reflect.TypeOf((*MockTaskPool)(nil).Len))
}

// Start mocks base method.
func (m *MockTaskPool) Start() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Start")
}

// Start indicates an expected call of Start.
func (mr *MockTaskPoolMockRecorder) Start() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Start", reflect.TypeOf((*MockTaskPool)(nil).Start))
}

// Stop mocks base method.
func (m *MockTaskPool) Stop() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Stop")
}

// Stop indicates an expected call of Stop.
func (mr *MockTaskPoolMockRecorder) Stop() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Stop", reflect.TypeOf((*MockTaskPool)(nil).Stop))
}

// Submit mocks base method.
func (m *MockTaskPool) Submit(task PriorityTask) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Submit", task)
	ret0, _ := ret[0].(error)
	return ret0
...
// Submit indicates an expected call of Submit.
func (mr *MockTaskPoolMockRecorder) Submit(task any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Submit", reflect.TypeOf((*MockTaskPool)(nil).Submit), task)
}

// TrySubmit mocks base method.
func (m *MockTaskPool) TrySubmit(task PriorityTask) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TrySubmit", task)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
...
// TrySubmit indicates an expected call of TrySubmit.
func (mr *MockTaskPoolMockRecorder) TrySubmit(task any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TrySubmit", reflect.TypeOf((*MockTaskPool)(nil).TrySubmit), task)
}
