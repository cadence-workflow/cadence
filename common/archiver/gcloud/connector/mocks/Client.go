...
// Source: github.com/uber/cadence/common/archiver/gcloud/connector (interfaces: Client)
//
// Generated by this command:
//
//	mockgen -package mocks -destination mocks/Client.go github.com/uber/cadence/common/archiver/gcloud/connector Client
//
...
func (m *MockClient) QueryWithFilters(ctx context.Context, URI archiver.URI, fileNamePrefix string, pageSize, offset int, filters []connector.Precondition) ([]string, bool, int, error) {
	m.ctrl.T.Helper()
