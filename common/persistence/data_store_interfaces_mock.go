...
// Source: github.com/uber/cadence/common/persistence (interfaces: ExecutionStore,ShardStore,DomainStore,TaskStore,HistoryStore,ConfigStore,DomainAuditStore,SemaphoreMetadataStore,SemaphoreTokenStore,HistoryDLQTaskStore)
//
...
func (mr *MockSemaphoreTokenStoreMockRecorder) GetSemaphoreTokenByID(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSemaphoreTokenByID", reflect.TypeOf((*MockSemaphoreTokenStore)(nil).GetSemaphoreTokenByID), ctx, request)
}
...
func (mr *MockSemaphoreTokenStoreMockRecorder) GetSemaphoreTokenByOwner(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSemaphoreTokenByOwner", reflect.TypeOf((*MockSemaphoreTokenStore)(nil).GetSemaphoreTokenByOwner), ctx, request)
}

// GrantSemaphoreToken mocks base method.
func (m *MockSemaphoreTokenStore) GrantSemaphoreToken(ctx context.Context, request *GrantSemaphoreTokenRequest, updatedTime time.Time) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockSemaphoreTokenStore) ListSemaphoreTokensByBucket(ctx context.Context, request *ListSemaphoreTokensByBucketRequest) (*ListSemaphoreTokensByBucketResponse, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSemaphoreTokenStoreMockRecorder) ListSemaphoreTokensByBucket(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListSemaphoreTokensByBucket", reflect.TypeOf((*MockSemaphoreTokenStore)(nil).ListSemaphoreTokensByBucket), ctx, request)
}
