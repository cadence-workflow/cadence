...
// CreateHistoryTasks provides a mock function for the type ExecutionManager
func (_mock *ExecutionManager) CreateHistoryTasks(ctx context.Context, request *persistence.CreateHistoryTasksRequest) error {
	ret := _mock.Called(ctx, request)

	if len(ret) == 0 {
		panic("no return value specified for CreateHistoryTasks")
	}

	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *persistence.CreateHistoryTasksRequest) error); ok {
		r0 = returnFunc(ctx, request)
	} else {
		r0 = ret.Error(0)
	}
...
// ExecutionManager_CreateHistoryTasks_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateHistoryTasks'
type ExecutionManager_CreateHistoryTasks_Call struct {
	*mock.Call
}

// CreateHistoryTasks is a helper method to define mock.On call
//   - ctx context.Context
//   - request *persistence.CreateHistoryTasksRequest
func (_e *ExecutionManager_Expecter) CreateHistoryTasks(ctx interface{}, request interface{}) *ExecutionManager_CreateHistoryTasks_Call {
	return &ExecutionManager_CreateHistoryTasks_Call{Call: _e.mock.On("CreateHistoryTasks", ctx, request)}
}

func (_c *ExecutionManager_CreateHistoryTasks_Call) Run(run func(ctx context.Context, request *persistence.CreateHistoryTasksRequest)) *ExecutionManager_CreateHistoryTasks_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 *persistence.CreateHistoryTasksRequest
		if args[1] != nil {
			arg1 = args[1].(*persistence.CreateHistoryTasksRequest)
		}
		run(
			arg0,
			arg1,
...
func (_c *ExecutionManager_CreateHistoryTasks_Call) Return(err error) *ExecutionManager_CreateHistoryTasks_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *ExecutionManager_CreateHistoryTasks_Call) RunAndReturn(run func(ctx context.Context, request *persistence.CreateHistoryTasksRequest) error) *ExecutionManager_CreateHistoryTasks_Call {
	_c.Call.Return(run)
	return _c
}
