...
// GetFailoverEvent responds to a GetFailoverEvent call based on the mock expectations. This
// call will fail if the mock does not expect this call. Use EXPECT to expect
// a call to this function.
//
//	client.EXPECT().GetFailoverEvent(gomock.Any(), ...).Return(...)
//	... := client.GetFailoverEvent(...)
func (m *MockClient) GetFailoverEvent(
	ctx context.Context,
	...
	i := 0
	ret := m.ctrl.Call(m, "GetFailoverEvent", args...)
	success, _ = ret[i].(*shared.GetFailoverEventResponse)
	i++
	err, _ = ret[i].(error)
	return
}

func (mr *_MockClientRecorder) GetFailoverEvent(
	ctx interface{},
	_GetRequest interface{},
	opts ...interface{},
) *gomock.Call {
	args := append([]interface{}{ctx, _GetRequest}, opts...)
	return mr.mock.ctrl.RecordCall(mr.mock, "GetFailoverEvent", args...)
}
