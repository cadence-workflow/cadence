// generated by deep-copy -o ./data_manager_deepcopy.gen.go -type GetDomainResponse -type ClusterReplicationConfig .; DO NOT EDIT.
		...
		if o.ReplicationConfig.Clusters != nil {
			...
			for i4 := range o.ReplicationConfig.Clusters {
				if o.ReplicationConfig.Clusters[i4] != nil {
					clusterCopy := o.ReplicationConfig.Clusters[i4].DeepCopy()
					cp.ReplicationConfig.Clusters[i4] = &clusterCopy
				}
			}
		}
